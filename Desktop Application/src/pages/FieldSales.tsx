...
import NewPickModal from '@/components/field-sales/NewPickModal';
  ...
  if (!canManage) {
    return (
      <div className="rounded-xl border border-slate-200 bg-white p-8 text-center">
        <p className="font-medium text-slate-800">Permission required</p>
    ...
    <div className="space-y-6">
      {!online && (
        <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
          You are offline. Field picks and reports are saved locally and will sync when
          you reconnect. Connect once first so agents and products are cached.
        </div>
      )}
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-slate-500">
            Register agents, issue product picks, and reconcile end-of-day field sales.
          </p>
        </div>
      ...
      {tab === 'active' ? (
              ...
              >
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    <p className="font-semibold text-slate-900">{pick.agentName}</p>
        ...
        <div className="space-y-4">
          ...
          {showAgentForm && (
            ...
            >
              <h3 className="mb-4 font-semibold text-slate-900">New field agent</h3>
                ...
                {agents.length === 0 ? (
                  ...
                  agents.map((agent) => (
                    <tr key={agent.id} className="hover:bg-slate-50/80">
                      ...
                      <td className="px-4 py-3.5">
                        <Link
                          to={`/field-sales/agents/${agent.id}`}
                          className="text-sm font-medium text-violet-600 hover:text-violet-700"
                        >
                          Profile
                        </Link>
