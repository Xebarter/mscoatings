...
import { submitFieldPickReportClient } from '@/lib/field-sales';
import type { FieldPick, SalePaymentMethod } from '@/lib/types';
            ...
            <div className="flex items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3">
              ...
              <div>
                ...
                <p className="text-xs text-amber-800">
                  Missing stock will be recorded as lost automatically.
                </p>
              </div>
            </div>
          )}
            ...
            <div className="flex flex-col gap-3 border-b border-slate-200 bg-slate-50/80 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Fill each row or apply a quick fill.
                </p>
              </div>
