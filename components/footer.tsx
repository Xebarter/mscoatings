      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/#solutions" className="transition-colors hover:text-cyan">Solutions</Link></li>
              <li><a href="#" className="transition-colors hover:text-cyan">Technical Support</a></li>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex items-start gap-3">
                ...
                <a href="mailto:info@mscoatings.com" className="text-white transition-colors hover:text-cyan">
                  info@mscoatings.com
                </a>
              </div>
              <div className="flex items-start gap-3">
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 text-sm md:flex-row">
          ...
          <div className="flex gap-6">
            <a href="#" className="transition-colors hover:text-cyan">Privacy Policy</a>
            <a href="#" className="transition-colors hover:text-cyan">Terms of Service</a>
            <a href="#" className="transition-colors hover:text-cyan">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
