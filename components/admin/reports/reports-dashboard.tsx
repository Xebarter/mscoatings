...
import { printEnterpriseReport } from './export-utils';
...
function ReportMetaBanner({ report }: { report: EnterpriseReport }) {
...
export default function ReportsDashboard() {
  ...
  const { report, isLoading, refresh } = useEnterpriseReport(filters);
        ...
        <ReportsAtmosphere>
          <div className="dark:text-slate-100">
            <ReportsPageHeader
              ...
              subtitle="Enterprise reporting hub for sales, inventory, finance, and operations."
            />
            ...
            <div id="reports-print-area" className="mt-4 space-y-4 pb-24 sm:mt-6 sm:space-y-6 sm:pb-10">
              {report && !isLoading && <ReportMetaBanner report={report} />}
